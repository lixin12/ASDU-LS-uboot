...
#define IOX_SDI IMX_GPIO_NR(5, 10)        // boot          unused
#define IOX_STCP IMX_GPIO_NR(5, 7)        // PCIE_DISABLE  ??
#define IOX_SHCP IMX_GPIO_NR(5, 11)       // boot          ??
#define IOX_OE IMX_GPIO_NR(5, 8)          // CSI_PWDN      ??

// delete  redefine   unused
...
/* I2C1 for PMIC and EEPROM */     //for PMIC Olny
...
#ifdef CONFIG_POWER
#define I2C_PMIC       0
int power_init_board(void)                //PMIC_INIT
{
	// if (is_mx6ull_9x9_evk()) {
		...
		printf("PMIC: PFUZE3001 DEV_ID=0x%x REV_ID=0x%x\n",
		       reg, rev_id);
...
void ldo_mode_set(int ldo_bypass)      //PMIC_SET
{
	unsigned int value;
	u32 vddarm;
...
static iomux_v3_cfg_t const uart2_pads[] = {
	...
	MX6_PAD_GPIO1_IO08__GPIO1_IO08 | MUX_PAD_CTRL(NO_PAD_CTRL),     //LED
...
#define USDHC1_CD_GPIO	IMX_GPIO_NR(4, 14)
...
#define ENET1_RST_GPIO	IMX_GPIO_NR(1, 3)
#define ENET2_RST_GPIO	IMX_GPIO_NR(1, 27)
...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	MX6_PAD_GPIO1_IO03__GPIO1_IO03 | MUX_PAD_CTRL(NO_PAD_CTRL),       //RST
};
...
static iomux_v3_cfg_t const fec2_pads[] = {
	...
	MX6_PAD_UART3_RTS_B__GPIO1_IO27 | MUX_PAD_CTRL(NO_PAD_CTRL),      //RST
};
...
static void setup_iomux_fec(int fec_id)
{
	...
	gpio_direction_output(ENET1_RST_GPIO, 0);
	udelay(500);
	gpio_direction_output(ENET1_RST_GPIO, 1);
	*/
	...
	else
	{
		imx_iomux_v3_setup_multiple_pads(fec2_pads,
	        ...
	        gpio_direction_output(ENET2_RST_GPIO, 0);
		udelay(500);
...
static iomux_v3_cfg_t const lcd_pads[] = {
	...
	MX6_PAD_LCD_RESET__LCDIF_RESET | MUX_PAD_CTRL(LCD_PAD_CTRL),
...
int board_init(void)
{
	...
	gpio_direction_output(IMX_GPIO_NR(1, 8) , 0);       //LED lit up
